...
import org.exoplatform.ecm.webui.component.explorer.control.filter.IsReferenceableNodeFilter;
...
@ComponentConfig(
     events = {
       @EventConfig(listeners = ViewReferencesActionComponent.ViewReferencesActionListener.class)
     }
 )
