...
public class JpdlXmlWriter {
  ...
  private static final Namespace jbpmNamespace = new Namespace(null, JPDL_NAMESPACE);
  ...
  public void write(ProcessDefinition processDefinition) {
    ...
    if (processDefinition==null) throw new NullPointerException("processDefinition is null");
    try {
  ...
  private Document createDomTree(ProcessDefinition processDefinition) {
    ...
    if ( processDefinition.getStartState()!=null ) {
      ...
      writeStartNode( root, processDefinition.getStartState() );
    }
    // write the nodeMap
