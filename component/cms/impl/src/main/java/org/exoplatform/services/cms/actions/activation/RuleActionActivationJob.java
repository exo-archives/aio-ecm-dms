...
import org.exoplatform.services.cms.actions.RuleActionPlugin;
 ...
 * Dec 21, 2006  
 */
public class RuleActionActivationJob implements Job {
  ...
  public void execute(JobExecutionContext context) throws JobExecutionException {
    ...
    ActionPlugin ruleActionService = actionServiceContainer.getActionPlugin(RuleActionPlugin.ACTION_TYPE) ;
    ...
    try {
      ...
      if (!hasPermission)
        return;
      ruleActionService.activateAction(userId,executable,variables) ;
