...
Release Notes - exo-ecm-dms - Version dms-3.0-alpha02

** Bug
    * [ECM-5004] - UI error when view Image on Details view
    * [ECM-5029] - Unknown error when do advance search in special case 
    * [ECM-5082] - UI error when view System file driver
    * [ECM-5117] - Unknown error when switch view between pages in special case 
    * [ECM-5187] - Correct user permission of Taxonomy Tree
    * [ECM-5236] - Action script errror
    * [ECM-5243] - Can not add or edit drive in WCM
    * [ECM-5250] - TaxonomyAction should not use System session
    * [ECM-5251] - FileExplorer icons in SideBar are not explicit
    * [ECM-5252] - FE : we shouldn't be able to add folders in categories
    * [ECM-5254] - FE : Favorites filter doesn't work
    * [ECM-5256] - Rename Favourites to Favorites


** Improvement
    * [ECM-3727] - Nothing happen when click Hide/show content icon on a node that is being locked
    * [ECM-5244] - See all views icons in FE
    * [ECM-5248] - SiteExplorer : access by url
    * [ECM-5249] - we could use Title instead of name in FE
    * [ECM-5253] - FE : Private drive is the default view
    * [ECM-5258] - FE : hide __system when owner
